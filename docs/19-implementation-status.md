...
| 007,012,013,016,017 | `packages/core`의 12슬롯·대기열·Esc 규칙, SQLite의 수정·선점 원자성. 18.2.5 실측에서 `abort`가 하위 에이전트 셸을 멈추지 않음([TV-004](evidence/TV-004/README.md)) | 12개 실제 동시 실행, 자손 포함 중단 경로, 엔진 전달·재개, UI 즉시/대기 입력 수용 |
